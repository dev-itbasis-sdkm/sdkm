...
go-build:
	...
	GOOS="${targetOS}" GOARCH="${targetARCH}" go build -trimpath -pgo auto -ldflags "-w -extldflags '-static' -X 'github.com/dev.itbasis.sdkm/internal/version.Version=${version}'" -tags musl -o "${targetDir}/sdkm" "./cmd/sdkm/main.go"
